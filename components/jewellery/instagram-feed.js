    ...
    <SectionReveal className="bg-[#f6f3f4] py-16 sm:py-20">
      <JewelleryContainer>
        <div className="mb-10 text-center">
          ...
          <h2 className="font-(family-name:--font-jewellery-display)] text-2xl font-medium italic text-[#1b1b1c] sm:text-[32px]">
            Follow Our Journey
          </h2>
        </div>
          ...
          {JEWELLERY_INSTAGRAM.map(({ id, alt, tone }) => (
            <li key={id}>
              <a
                ...
                aria-label={alt}
                className={cn(
                  "group block aspect-square overflow-hidden rounded-xl bg-linear-to-br transition hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#D4AF37] focus-visible:ring-offset-2",
                  tone,
                )}
              >
