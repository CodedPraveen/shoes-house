    ...
    <>
      ...
      >
        <nav className="mx-auto flex h-20 w-full max-w-350 items-center justify-between px-5 sm:px-8">
          ...
          ">
            <svg xmlns="http://www.w3.org/2000/svg" width="260" height="64" viewBox="0 0 360 64" fill="black">
              <g fill="#0A192F">
