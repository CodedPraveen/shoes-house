...
export default function HeroSection() {
  //   return (
  //     <section className="relative min-h-screen overflow-hidden px-5 pt-12 sm:px-8">
  ...
  //           <span className="absolute text-red-600 w-full">SHOES HOUSE</span>
  //           <img height={520} width={1400} src="https://cdn.cartpe.in/images/gallery_lg/37710ab12b80fdbc6fd133ffbeefe1f6.png" alt="hero-section"
  //             className=""
  //           />
  //         </div>
  //       </div>
