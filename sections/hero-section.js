    ...
    <section className="relative min-h-screen overflow-hidden px-5 pt-20 sm:px-8">
      ...
      <div className="mx-auto grid w-full max-w-[1400px] items-center gap-12 py-8 lg:grid-cols-2 lg:py-13">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute -right-2 -top-3 z-10 rounded-full border border-black/15 bg-white/85 px-5 py-2 text-xs uppercase tracking-[0.18em] text-black/60 backdrop-blur">
            Limited Edition
          </div>
