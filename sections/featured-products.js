  ...
  export default function FeaturedProducts({ products, title = "Curated for quiet luxury.", subtitle = "Featured Products" }) {
   
    return (
      <SectionReveal className="px-0 py-1 sm:px-8 lg:py-10">
        <div className="mx-auto w-full max-w-350 space-y-10">
          <div className="flex flex-wrap items-end justify-between gap-4 px-5 py-2 mb-2 sm:mb-10">
